...
class Parser:
    ...
    def expr(self):
        ...
        if res.error:
            return res.failure(InvalidSyntaxError(self.current_tok.pos_start, self.current_tok.pos_end, "Ожидали 'ПЕРЕМ', целое число, число с плавающей точкой, индентифекатор, '+', '—', или '('"))
