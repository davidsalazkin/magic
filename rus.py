...
class Parser:
    ...
    def factor(self):
        ...
        return res.failure(InvalidSyntaxError(tok.pos_start, tok.pos_end, "Ожидали целое число или число с плавающей точкой"))
...
class Interpreter:
    ...
    def no_visit_method(self, node, context):
        raise Exception(f'visit_{type(node).__name__} метод не определен')
